...
"}"))
        ...
        QtCore.QObject.connect(self.sliderObj, QtCore.SIGNAL(_fromUtf8("valueChanged()")), self.textEditObj.update)
    ...
    def printHistory(self):
        ...
        self.textEditObj.append("Average Temp = "+str(sum(myTemp)/len(myTemp))+"\n")
        self.textEditObj.append("Average Humidity = "+str(sum(myHumidity)/len(myHumidity))+"\n")
